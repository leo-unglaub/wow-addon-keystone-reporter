...
KeystoneReporter.HandlerEvents.eventFrame.CHAT_MSG_PARTY = function(text)
	KeystoneReporter.HandlerEvents.ReplyToKey(text)
end

-- Event Handler: CHAT_MSG_PARTY_LEADER
KeystoneReporter.HandlerEvents.eventFrame.CHAT_MSG_PARTY_LEADER = function(text)
	KeystoneReporter.HandlerEvents.ReplyToKey(text)
end


-- Event Handler: CHAT_MSG_ADDON
KeystoneReporter.HandlerEvents.eventFrame.CHAT_MSG_ADDON = function(text)
